    ...
    for row in data:
        ...
        if row[-1] == '192':
            if save_row:
                ...
                if msrt_tag.endswith('IERR') or msrt_tag.endswith('IGRR'):
                    continue
                ...
                if prev_msrt_datetime != msrt_datetime:
                    ...
                    samples_dict[msrt_datetime]['machine_name'] = machine_name
                    samples_dict[msrt_datetime]['time'] = msrt_datetime
                
                samples_dict[msrt_datetime][msrt_tag] = float(msrt_value)
                prev_msrt_datetime = msrt_datetime
